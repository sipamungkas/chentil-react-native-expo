...
const MENU_ITEMS = [
  { icon: Compass, label: 'Destinations', color: '#FF4D8D', route: '/destination' },
  { icon: Plane, label: 'Outbound', color: '#4299E1', route: '/outbound' },
  { icon: Palette, label: 'Culture', color: '#48BB78', route: '/culture' },
  { icon: Utensils, label: 'Food & Beverage', color: '#ED8936', route: '/food-and-beverage' },
  { icon: Star, label: 'Recommendations', color: '#9F7AEA', route: "recommendations" },
